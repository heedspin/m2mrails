authorization do
  ...
  role :shipping do
    ...
    has_permission_on :sales_customers, :to => :read
  ...
  role :sales do
    ...
    has_permission_on :context_contexts, :to => :manage
    has_permission_on :context_comments, :to => :manage
    has_permission_on :context_chrome_extensions, :to => :read
  end
  ...
  role :admin do
    ...
    has_permission_on :quality_inspection_tasks, :to => :edit_last_receiver_id
  end
end

privileges do
  privilege :manage, :includes => [:make, :read, :update, :destroy, :move, :fix_positions, :clone]
